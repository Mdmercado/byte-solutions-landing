...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      {/* ====== NAVBAR ====== */}
      <nav
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-background/80 backdrop-blur-xl border-b border-border shadow-sm" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto flex items-center justify-between h-20 px-4 lg:px-8">
          <button
            ...
            <BrandLogo
              className="h-20 sm:h-26 md:h-32 w-auto object-contain"
              width={320}
              height={110}
            />
          </button>
      ...
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            <Badge
              variant="secondary"
              className="mb-6 text-xs font-medium tracking-wide bg-primary text-primary-foreground">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed text-pretty">
              Creamos bots de WhatsApp con IA, plataformas SaaS desde ~$50
              USD/mes y desarrollo a medida para cualquier industria. Tu
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-balance">
              Tres pilares, infinitas posibilidades
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              Nuestro modelo se basa en proyectos personalizados y suscripciones
              SaaS accesibles, no en planes genericos.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={s.title}
                className="flex flex-col p-8 hover:border-primary/30 transition-colors group">
                ...
                <Button
                  variant="ghost"
                  className="w-fit gap-2 -ml-4 text-primary hover:text-primary"
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20">
              ...
              <span className="text-sm font-medium text-primary">
                Soluciones SaaS ~$50 USD/mes
              </span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-balance">
              Plataformas listas para implementar
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              Sistemas probados con IA y bot de WhatsApp incluido. Suscripcion
              mensual accesible, sin grandes inversiones iniciales.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Gestion integral para gimnasios y centros fitness. Bot de
                WhatsApp para reservas automaticas, cobros recurrentes, y
                reportes con analisis predictivo.
              </p>
              <ul className="flex flex-col gap-3 mb-8">
                {[
                  "Gestion de miembros y membresias",
                  "Bot WhatsApp: reservas, pagos, recordatorios",
                  "Cobros recurrentes automatizados",
                  "Dashboard con IA predictiva",
                  "App mobile para socios",
                ].map((f) => (
              ...
              <div className="flex flex-wrap gap-3">
                <Button onClick={() => openPlan("gym")} className="gap-2">
                  Solicitar Demo <ArrowRight className="h-4 w-4" />
                </Button>
                <Button variant="outline" className="gap-2" asChild>
                  <a href="#" target="_blank" rel="noopener noreferrer">
                    Probar Gratis <ExternalLink className="h-4 w-4" />
                  </a>
                </Button>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                <Image
                  src="/products/gym-dashboard.jpg"
                  alt="GymManager Pro Dashboard"
                  width={800}
                  height={500}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24">
            <div>
              <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                <Image
                  src="/products/carwash-dashboard.jpg"
                  alt="WashFlow Dashboard"
                  width={800}
                  height={500}
                  className="w-full h-auto"
                />
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Sistema completo para lavaderos de autos. Turnos via WhatsApp,
                seguimiento de vehiculos en tiempo real y facturacion
                automatizada con metricas IA.
              </p>
              <ul className="flex flex-col gap-3 mb-8">
                {[
                  "Turnos automaticos via bot WhatsApp",
                  "Seguimiento de vehiculos en tiempo real",
                  "Facturacion y cobros integrados",
                  "Dashboard con metricas e IA",
              ...
              <div className="flex flex-wrap gap-3">
                <Button onClick={() => openPlan("carwash")} className="gap-2">
                  Solicitar Demo <ArrowRight className="h-4 w-4" />
                </Button>
                <Button variant="outline" className="gap-2" asChild>
                  <a href="#" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Inventario inteligente para PyMEs. Alertas de stock con IA,
                analisis de rotacion, bot de WhatsApp para consultas y gestion
                multi-sucursal.
              </p>
              <ul className="flex flex-col gap-3 mb-8">
                {[
                  "Control de inventario multi-sucursal",
                  "Alertas inteligentes de stock (IA)",
                  "Reportes de ventas y rotacion",
                  "Bot WhatsApp para consultas de stock",
              ...
              <div className="flex flex-wrap gap-3">
                <Button onClick={() => openPlan("inventory")} className="gap-2">
                  Solicitar Demo <ArrowRight className="h-4 w-4" />
                </Button>
                <Button variant="outline" className="gap-2" asChild>
                  <a href="#" target="_blank" rel="noopener noreferrer">
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-xl overflow-hidden border border-border shadow-lg">
                <Image
                  src="/products/inventory-dashboard.jpg"
                  alt="StockByte Dashboard"
                  width={800}
                  height={500}
                  className="w-full h-auto"
                />
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 relative">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20">
              ...
              <span className="text-sm font-medium text-primary">
                Bots de WhatsApp + Inteligencia Artificial
              </span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-balance">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              Nuestros bots combinan WhatsApp con IA avanzada para automatizar
              cada punto de contacto con tus clientes. Mas ventas, menos carga
              operativa.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Atencion automatizada 24/7. Reservas, consultas, seguimiento y cobros sin intervencion humana.",
              },
              {
                icon: BarChart3,
                title: "Reportes Automaticos",
                desc: "Informes semanales generados por IA con insights accionables y recomendaciones de negocio.",
              },
              {
                icon: BellRing,
                title: "Mensajes Inteligentes",
                desc: "Recordatorios de pago, alertas de stock, seguimiento post-venta. Todo automatizado.",
              },
              {
                icon: Brain,
                title: "Analisis Predictivo",
                desc: "Prediccion de demanda, churn de clientes, oportunidades de crecimiento con machine learning.",
              },
            ].map((item) => (
              <Card
                key={item.title}
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-4">
                  WhatsApp Business + IA = Resultado
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Implementamos bots personalizados que atienden, venden y
                  fidelizan por vos. Integramos con tu sistema de gestion
                  existente o con cualquiera de nuestras plataformas SaaS.
                </p>
                <Button onClick={() => openPlan("bot")} className="gap-2">
                  Quiero un Bot para mi Negocio{" "}
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={s.label}
                    className="p-4 rounded-lg bg-muted border border-border text-center">
      ...
      <section id="custom" className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-balance">
              Tu idea, nuestro codigo
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              No vendemos paquetes genericos. Analizamos tu negocio, entendemos
              tus procesos y construimos exactamente la solucion que necesitas,
              con IA integrada.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Productos multi-tenant escalables con suscripciones e IA.",
              },
              {
                icon: Smartphone,
                title: "Apps Web & Mobile",
                desc: "React, Next.js, React Native con integraciones nativas.",
              },
              {
                icon: Bot,
                title: "Bots & Automatizacion",
                desc: "WhatsApp, Telegram, workflows automatizados con IA.",
              },
              {
                icon: Globe,
                title: "APIs & Integraciones",
                desc: "Conectamos tus sistemas existentes de forma segura.",
              },
            ].map((item) => (
              <Card
                key={item.title}
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-4">
              No importa tu rubro. Creamos la solucion perfecta para tu negocio
              con IA integrada.
            </p>
      ...
      <section id="testimonials" className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              Empresas reales que automatizaron su operacion con nuestros bots,
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-sm max-w-xl mx-auto">
              Proyectos que demuestran nuestra capacidad.
            </p>
          </div>
            ...
            {[
              {
                ...
                img: "/products/gym-dashboard.jpg",
              },
              {
                title: "WashFlow",
                category: "SaaS - Automotor",
                img: "/products/carwash-dashboard.jpg",
              },
              {
                title: "StockByte",
                category: "SaaS - Inventario",
                img: "/products/inventory-dashboard.jpg",
              },
            ].map((project) => (
              <Card
                key={project.title}
      ...
      <section id="about" className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-sm font-medium text-primary mb-3 tracking-wide uppercase">
                Por que Byte Solutions IT
              </p>
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-balance">
                No vendemos planes, resolvemos problemas
              </h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                Nuestro modelo es simple: entendemos tu negocio, te proponemos
                una solucion concreta y la construimos. Si ya tenemos un SaaS
                que se adapta, lo implementamos por ~$50 USD/mes. Si necesitas
                algo especifico, lo desarrollamos a medida.
              </p>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Toda solucion incluye inteligencia artificial y automatizacion
                via WhatsApp. Somos un equipo de fundadores con experiencia en
                empresas tech lideres de Latinoamerica.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { value: "+50", label: "Proyectos entregados" },
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-card border border-border rounded-xl p-10 text-center">
                  <BrandLogo
                    className="h-32 sm:h-36 md:h-40 w-auto mx-auto mb-6"
                    width={320}
                    height={110}
                  />
                  <p className="text-sm text-muted-foreground italic leading-relaxed">
                    {'"'}Creemos que la tecnologia y la IA deben ser accesibles
                    para todos los negocios, sin importar su tamaño.{'"'}
                  </p>
                  <div className="mt-4 text-xs text-muted-foreground">
                    -- El equipo de Byte Solutions IT
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="team" className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              Un equipo multidisciplinario con experiencia en empresas tech
              lideres.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card
                ...
                <p className="text-xs text-muted-foreground leading-relaxed text-center mb-5">
                  {member.bio}
                </p>
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2 rounded-md border border-border text-sm text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
      ...
      <section id="booking" className="py-24">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
              30 minutos gratis con nuestro equipo para analizar tus necesidades
              y proponerte la mejor solucion.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              {[
                {
                  ...
                  desc: "Analizamos tu negocio y te proponemos bots, SaaS o desarrollo a medida.",
                },
                {
                  icon: Zap,
                  title: "30 Min, Sin Compromiso",
                  desc: "Tiempo para entender tus necesidades y darte una propuesta concreta.",
                },
                {
                  icon: Briefcase,
                  title: "Habla con los Fundadores",
                  desc: "Acceso directo a nuestros expertos para una perspectiva estrategica.",
                },
              ].map((item) => (
              ...
              <Card className="p-5">
                <h4 className="font-medium text-sm mb-3">
                  Que incluye la llamada
                </h4>
                <ul className="flex flex-col gap-2">
                  {[
                    "Analisis de tus procesos actuales",
                    "Demo de productos SaaS relevantes",
                    "Propuesta de bots e IA aplicada",
                ...
                <div className="p-4 border-b border-border flex items-center gap-3 bg-card">
                  ...
                  <div>
                    <p className="text-sm font-medium">
                      Byte Solutions IT - Llamada Estrategica
                    </p>
                    <p className="text-xs text-muted-foreground">
                      30 min | Google Meet
                    </p>
                ...
                <div
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center bg-card">
                    ...
                    <p className="text-sm text-muted-foreground mb-6 max-w-sm">
                      Configura tu URL de Calendly para habilitar reservas
                      directas.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button
                        ...
                        className="gap-2">
                        <Mail className="h-4 w-4" /> Contactar por Mail
                      </Button>
                      <Button variant="outline" asChild>
                        <a
                          ...
                          rel="noopener noreferrer"
                          className="gap-2">
                          <ExternalLink className="h-4 w-4" /> Ir a Calendly
                        </a>
                      </Button>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Ya sea un bot de WhatsApp, una plataforma SaaS o un desarrollo
                completo a medida, escribinos y te respondemos en menos de 24
                horas con una propuesta concreta.
              </p>
                ...
                {[
                  {
                    icon: Mail,
                    title: "Email",
                    value: "contacto@bytesolutions.com",
                  },
              ...
              <CardContent className="px-0 pb-0">
                <form
                  ...
                  onSubmit={(e) => {
                    ...
                    window.open(
                      `mailto:contacto@bytesolutions.com?subject=${subject}&body=${body}`,
                      "_blank",
                    );
                  }}>
                  ...
                  <div>
                    ...
                    <textarea
                      name="mensaje"
                      rows={4}
                      placeholder="Contanos que necesitas: bot, SaaS, desarrollo a medida..."
                      required
                  ...
                  <Button type="submit" className="w-full gap-2">
                    <Zap className="h-4 w-4" /> Enviar Mensaje
                  </Button>
                </form>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              />
              <p className="text-sm text-muted-foreground leading-relaxed">
                Bots de WhatsApp con IA, soluciones SaaS accesibles y desarrollo
                a medida para cualquier industria.
              </p>
            </div>
            <div>
          ...
          <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">
              {new Date().getFullYear()} Byte Solutions IT. Todos los derechos
              reservados.
            </p>
